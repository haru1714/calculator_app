...
btn_plus = tk.Button(root,text="+",width="5",font=("Arial",30),activebackground="gray",command=lambda:operator_input(1))
btn_minus = tk.Button(root,text="-",width="5",font=("Arial",30),activebackground="gray",command=lambda:operator_input(2))
