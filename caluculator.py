...
icon = tk.PhotoImage(file="caluculator_icon.png")
...
btn_1 = tk.Button(root,text="1",width="7",font=("Arial",30),activebackground="gray",command=lambda:number_click(number=1,now_number=now_number))
